...
class User < ActiveRecord::Base
  ...
  has_many :received_moderations, :class_name => "Moderation", :foreign_key => "targetted_user_id", :dependent => :nullify
  has_many :issued_moderations, :class_name => "Moderation", :foreign_key => "moderator_id", :dependent => :destroy # If the moderator deletes his account, delete the corresponding log entries.

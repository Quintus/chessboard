...
attribute <tt>plugin_data</tt> to some classes (currently only +Post+,
+GlobalConfiguration+, and +User+). This attribute holds a hash in which
plugins can place their own data. Please use the name of your plugin
as they key, e.g.:
